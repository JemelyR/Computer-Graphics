...
// ################ Edit your code below
    ...
    var viewportMatrix = new SimpleMatrix();
    var fullTransformChain = new SimpleMatrix();

    //inverse view matrix
    // var inverseView = SimpleMatrix.inverse(view);
    var inverseView = view.inverse();

    viewportMatrix = SimpleMatrix.viewport(canvas.width, canvas.height);

    var projectedInverse = SimpleMatrix.multiply(projection, inverseView);
    modelViewProjectionMatrix = SimpleMatrix.multiply(projectedInverse, model);

    fullTransformChain = viewportMatrix.multiply(modelViewProjectionMatrix);
