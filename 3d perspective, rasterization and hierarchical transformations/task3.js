...
// ################ Edit your code below
    var first = SimpleMatrix.translate(point[0], point[1], point[2]).multiply(SimpleMatrix.rotate(angle, axis[0], axis[1], axis[2]));
    mat = first.multiply(SimpleMatrix.translate(-point[0], -point[1], -point[2]));
// ################
