...
// ################ Edit your code below    
    ...
    pose = SimpleMatrix.translate(this.position[0], this.position[1], this.position[2]).multiply(rotation);
    if(this.parent !== null){
        
        pose = this.parent.computePoseMatrix().multiply(pose);
    }
// ################
...
// ################ Edit your code below
// ################
    pose = this.computePoseMatrix().multiply(SimpleMatrix.scale(this.scale[0], this.scale[1], this.scale[2]));
