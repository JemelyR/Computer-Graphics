...
// ################ Edit your code below
	...
	if (this.nodes.length == 3)
	{
		...
		var p12 = Node.lerp(p10, p11, t);

		left.nodes.push(p00, p10, p12);
		right.nodes.push(p12, p11, p02);
	}
	else if (this.nodes.length == 4)
	{
		...
		var p13 = Node.lerp(p10, p11, t);
		var p14 = Node.lerp(p11, p12, t);
		var p15 = Node.lerp(p13, p14, t);

		left.nodes.push(p00, p10, p13, p15);
		right.nodes.push(p15, p14, p12, p03);
	}
// ################
